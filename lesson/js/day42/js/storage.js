...
// 가져오기 
function getItem(set_key, obj){


	if( set_key !== 'string' ){
		console.log('문자열 key를 입력하시오');
	} else {
		localstorage.getItem(set_key);
	}
}

function setItem(set_key, val, obj){
	JSON.stringify()

	localstorage.setItem(set_key, val);
}
