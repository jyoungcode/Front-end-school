...
demo1.onclick = function() {
  ...
  // myFn.call(this); // myFn :함수 , call(this) this는 객체다 myFn이 this라는 객체를 빌려온것이다. 왜냐면 함수(메서드)가 객체에 속성이기 떄문에
};
...
// var $this = evt.data.$this; ( 원래 jquery event 객체에 존재하는 data에 $this를 접근해서 사용, 하지만 보통 onclick({'$this'의 경우는 이벤트 객체에 $this를 매번 생성 하는 거라서 낭비가 심하다. 그래서 evt.data.$this는 효율적이다.}))
